  ...
  return (
    <div className="relative">
      <button
        ...
        className={cn(
          "group relative flex h-9 w-9 items-center justify-center rounded-lg touch-manipulation",
            ...
            <div className="space-y-1.5">
              {Object.entries(themes).map(([key, theme]) => (
                <button
                  ...
                  className={cn(
                    "w-full flex items-center gap-3 px-3 py-2.5 rounded-lg touch-manipulation",
