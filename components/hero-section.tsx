      ...
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-20 lg:items-center lg:min-h-[70vh]">
          ...
          <div className="space-y-8 sm:space-y-10">
            ...
            <div className="max-w-lg text-base sm:text-lg leading-relaxed text-muted-foreground animate-fade-in-up stagger-2">
              <p>{t("hero.description")}</p>
              <p className="mt-4 whitespace-pre-line">{t("hero.description2")}</p>
            </div>

            <div className="flex flex-row gap-3 sm:gap-4 animate-fade-in-up stagger-3">
              <a
                href="#projects"
                className="group relative inline-flex items-center justify-center gap-2 sm:gap-3 overflow-hidden rounded-lg border border-primary bg-primary/10 px-5 sm:px-7 py-3 sm:py-3.5 font-mono text-xs sm:text-sm text-primary transition-all duration-500 hover:bg-primary hover:text-primary-foreground active:scale-[0.98] flex-1"
              >
              ...
              <Link
                href="/introduction"
                className="group inline-flex items-center justify-center gap-2 sm:gap-3 rounded-lg border border-border px-5 sm:px-7 py-3 sm:py-3.5 font-mono text-xs sm:text-sm text-muted-foreground transition-all duration-300 hover:border-foreground hover:text-foreground hover:bg-secondary/50 active:scale-[0.98] flex-1"
              >
          ...
          <div className="relative animate-scale-in stagger-4">
            <div className="relative rounded-xl border border-border bg-card/60 glass p-3 sm:p-6 hover-lift">
              ...
              <pre className="mt-6 mb-8 overflow-visible text-[11px] leading-[1.35] text-primary/80 sm:text-[13px] sm:leading-[1.35]" style={{ 
